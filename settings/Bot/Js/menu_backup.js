const Menu = ( timeFt , Bot , prefixo, sender , groupName  , groupMembers ) => {  
return `
 ❱ ➢${timeFt}, @${sender.split('@')[0]} 
╭══════════════════ 
│✦ ➮ sᴏʏ: ${Bot}
│✦ ➮ ᴘʀᴇғɪᴊᴏ ᴀᴄᴛᴜᴀʟ: *${prefixo}*
│✦ ➮ ᴘᴀɢɪɴᴀ ᴏғɪᴄɪᴀʟ:  https://api.naufrabot.com
╰━━━━━─「✪」─━━━━━
...
╰  
*➢welcome 1/0*
> ➥Activa/desactiva las bienvenidas y despedidas
*➢antilink 1/0*      
